    ...
    const [orderResult] = await connection.execute(
      `INSERT INTO orders
         (user_id, status, subtotal, discount, coupon_code, shipping_cost, tax_amount, total, qr_reference,
          shipping_first_name, shipping_last_name, shipping_complement,
          shipping_street, shipping_street_number, shipping_city, shipping_zip, shipping_country, shipping_canton,
          shipping_phone,
          billing_first_name, billing_last_name, billing_complement,
...
const findAllByUserIdWithItems = async (userId) => {
  const [orders] = await pool.execute(
    `SELECT o.id, o.invoice_number, o.status, o.subtotal, o.discount, o.coupon_code,
            ...
            o.created_at, o.updated_at,
            o.shipping_first_name, o.shipping_last_name, o.shipping_complement, o.shipping_street, o.shipping_street_number,
            o.shipping_city, o.shipping_zip, o.shipping_country, o.shipping_canton, o.shipping_phone,
            o.billing_first_name, o.billing_last_name, o.billing_complement, o.billing_street, o.billing_street_number,
...
const findById = async (orderId, userId = null) => {
  ...
  const [orders] = await pool.execute(
    `SELECT o.id, o.status, o.subtotal, o.discount, o.coupon_code, o.shipping_cost, o.tax_amount, o.total,
            ...
            o.shipping_first_name, o.shipping_last_name, o.shipping_complement,
            ...
            o.billing_first_name, o.billing_last_name, o.billing_complement,
