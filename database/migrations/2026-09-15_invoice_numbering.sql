...
--              mettre l'année et le mois plus un numéro EX 2026-09/01 ».
...
-- Effet      : 1) orders.invoice_number — numéro affiché (ex. « 2026-09/01 »),
--                 figé à l'émission de la facture, jamais recalculé ;
--              2) orders.invoice_seq — compteur brut (1, 2, 3…) du mois, sert
--                 à construire la référence QR numérique ;
--              3) invoice_counters — un compteur par mois (période AAAA-MM),
--                 incrémenté de façon atomique : deux commandes simultanées ne
--                 peuvent pas obtenir le même numéro.
-- Comptabilité : la séquence est continue et sans trou par mois — une facture
