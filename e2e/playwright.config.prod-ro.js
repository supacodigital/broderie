...
/* Variante READ-ONLY : aucune écriture en base.
   → pas de globalSetup (qui ferait un /auth/register). */
...
export default defineConfig({
  ...
  /* PAS de globalSetup ici — run strictement lecture seule */

  reporter: [
    ['list'],
    ['html', { outputFolder: 'playwright-report-prod-ro', open: 'never' }],
  ],
